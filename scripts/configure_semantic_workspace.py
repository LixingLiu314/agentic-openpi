...
def save_workspace(root, *, display_set="official-pi05-semantic-pair-s42-v1", name="Pi05 semantic S and action consistency s42 v1", receipt=None):
    import wandb
    ...
    sections.insert(4, section("03c 新损失 · 与原始 CE / flow 分开", [
        plot("关键语义加权 CE | 实际 S 目标", "semantic/weighted_ce", "Weighted token CE"),
        plot("文字—动作 margin 违例 | 辅助项", "semantic/action_rank_hinge", "Native14 flow hinge"),
        plot("参与文字—动作约束的样本数 | global", "semantic/action_rank_pairs", "Pairs / update"),
    ], False))
    ...
    runset = ws.RunsetSettings(
        ...
        groupby=[], run_settings={"semantic_s_seed42_v1": ws.RunSettings(color="#2563EB"), "semantic_s_actionrank_seed42_v1": ws.RunSettings(color="#EA580C")},
...
if __name__ == "__main__":
    ...
    parser.add_argument("--display-set", default="official-pi05-semantic-pair-s42-v1")
    parser.add_argument("--name", default="Pi05 semantic S and action consistency s42 v1")
