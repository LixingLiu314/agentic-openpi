"""Serve a schema5 official-initialized gradient checkpoint through the native policy interface."""
...
def main():
    ...
    policy = create_official_gradient_policy(args.checkpoint, device=args.device)
