"""N1 first-update media; native text is display-only, never action conditioning."""
...
def render_first_step(model, batch, data_config, output, *, step=1, origin="live first update; cold-start S diagnostic", limit=2):
    ...
    manifest = {
        ...
        "origin": origin,
        "stage": model.stage,
        "action_note": "N1 native VLM: global task/state/images condition A; subtask text is display-only.",
        "flow_steps": 10,
        "noise_seed": 73001,
        "samples": [],
    }
