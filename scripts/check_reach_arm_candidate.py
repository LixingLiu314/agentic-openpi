...
def main():
    ...
    policy = create_reach_arm_policy(args.checkpoint, device=args.device,
    ...
    if args.allow_engineering:
        ...
        ce = model.decoder.loss_projected(sequence.target_ids,sequence.target_mask,projected,mask,model.embedding_weight)
        ce.backward()
        ...
        model.zero_grad(set_to_none=True)
        gradient_contract = dict(ce_only_S=True,recurrence_gradient_nonzero=True,action_only_A_and_limited_B=True,
