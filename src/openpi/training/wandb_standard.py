...
TRAIN = {
    ...
    "loss_action": "train/action_flow_mse_all32",
    "lr": "optim/lr",
...
VALIDATION = {
    ...
    "flow_generated_native14_normalized": "val/action_flow_mse_native14",
    "flow_generated_all32": "val/action_flow_mse_all32",
}
...
def event_payload(row, config):
    ...
    if event == "train":
        ...
        for source, target in {"subtask": "optim/grad_norm_s", "action_backbone": "optim/grad_norm_a_b"}.items():
...
def configure_run(run):
    ...
    for metric in ("val/action_flow_mse_native14", "val/action_flow_mse_all32", "val/subtask_ce"):
