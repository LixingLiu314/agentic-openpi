...
def event_payload(row, config):
    ...
    if event == "train":
        ...
        for source, target in {"subtask": "optim/grad_norm_s", "action": "optim/grad_norm_a", "backbone": "optim/grad_norm_b", "subtask_sampled_relative_update":"optim/update_sampled_relative_s", "backbone_sampled_relative_update":"optim/update_sampled_relative_b", "action_sampled_relative_update":"optim/update_sampled_relative_a"}.items():
